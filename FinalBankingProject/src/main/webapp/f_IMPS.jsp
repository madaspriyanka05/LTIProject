      ...
      <div class="mainbar">
        <div class="article">
            ...
            <form action="" method="POST">
                <table id="funds">
                        <caption>Initiate IMPS Transaction</caption>
                        <tr><td>&nbsp;</td></tr>
                        <tr>
                            <td><h3>From Account Name:<h3></h3></td>
                            <td><input type="text" placeholder="Minions" id="IMPSfromAccName"></td>
                        </tr>
                        <tr>
                            <td><h3>From Account Number:<h3></h3></td>
                            <td><input type="text" placeholder="123456789" id="IMPSfromAccNumber"></td>
                        </tr>
                        <tr>
                            <td><h3>To Account Name:<h3></h3></td>
                            <td><input type="text" placeholder="Minions" id="IMPStoAccName"></td>
                        </tr>
                        <tr>
                                <td><h3>To Account Number:<h3></h3></td>
                                <td><input type="text" placeholder="123456789" id="IMPStoAccNumber"></td>
                            </tr>
                        <tr>
                            <td><h3>Amount:<h3></h3></td>
                            <td><input type="text" placeholder="100" id="IMPSamount"></td>
                        </tr>
                        <tr>
                            <td><h3>Remark:<h3></h3></td>
                            <td><input type="text" placeholder="Remark" id="IMPSremark"></td>
                        </tr>
                        <tr><td>&nbsp;</td></tr>
                        <tr>
